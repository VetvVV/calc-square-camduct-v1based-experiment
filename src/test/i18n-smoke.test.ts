...
describe('i18n smoke', () => {
  ...
  it('keeps en free of ru headings', () => {
    const text = [en.spec.item, en.summary.title, en.materials.title, en.calculator.resultTitle].join(' ')
  ...
  it('keeps uk main headings localized', () => {
    const text = [uk.spec.item, uk.summary.title, uk.materials.title, uk.calculator.resultTitle].join(' ')
